    ...
    <div>
      ...
      <div id="selectOperation">
        ...
        <div v-if="isEdit" style="padding-top: 5px">
          <Button type="primary" style="margin-right: 10px;margin-left: 50px" @click="saveMenu">保存菜单</Button>
        ...
        <div class="editDish" v-for="(item, index1) in editMenu.types">
          ...
          <div class="dishOnly" v-for="(dish,index2) in item.dishes">
            <div style="float: left;padding-left: 5px">
              <img src="../../assets/canteen_avatar3.png" style="width: 80px;height: 80px;margin-top: 10px"/>
            </div>
