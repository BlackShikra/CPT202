<template>
  <div style="background-color: #f8f8f9">
    ...
    <div id="canteen" style="margin-bottom: 20px">
      ...
      <div id="canteen1"
           style="width: 1063px;height: 400px;margin-left: 15%;margin-right: 15%;background-color: white;padding: 10px;margin-top: 10px"></div>
      <div
        style="width: 1063px;height: 400px;margin-left: 15%;margin-right: 15%;background-color: white;padding: 10px;margin-top: 10px">
    ...
    <div id="customer" style="margin-bottom: 20px">
      ...
      <div id="customer1"
           style="width: 1063px;height: 400px;margin-left: 15%;margin-right: 15%;background-color: white;margin-bottom: 10px;padding: 10px;margin-top: 10px"></div>
    ...
    <div id="cash">
      ...
      <div id="cash1"
           style="width: 1063px;height: 400px;margin-left: 15%;margin-right: 15%;background-color: white;padding: 10px;margin-top: 10px;margin-bottom: 10px"></div>
      <div style="width: 1063px;height: 400px;margin-left: 15%;margin-right: 15%;background-color: white;padding: 10px">
